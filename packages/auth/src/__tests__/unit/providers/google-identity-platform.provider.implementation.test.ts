...
import {
  createMockFirebaseIdentityPlatformProvider,
  mockFirebaseAdmin
} from '../../../providers/__mocks__/firebase-mock';
...
describe('GoogleIdentityPlatformAuthProvider - Implementation Tests', () => {
  ...
  afterEach(() => {
    // Clean up mock Firebase apps to prevent test interference
