import type { CreateIssueAttachmentDto } from '../dto';
import type { RequestTrace } from '@/common/cqrs/request-trace';
import type { ICommand } from '@package/types';

export class CreateIssueAttachmentCommand implements ICommand {
  ...
  constructor(
    ...
    public readonly dto: CreateIssueAttachmentDto,
    trace: RequestTrace = {}
  ) {
