import type { CreateIssueAttachmentUploadDto } from '../dto';
import type { RequestTrace } from '@/common/cqrs/request-trace';
import type { ICommand } from '@package/types';

export class CreateIssueAttachmentUploadCommand implements ICommand {
  ...
  constructor(
    ...
    public readonly dto: CreateIssueAttachmentUploadDto,
    trace: RequestTrace = {}
  ) {
