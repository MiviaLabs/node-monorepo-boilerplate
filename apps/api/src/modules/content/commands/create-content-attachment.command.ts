import type { CreateContentAttachmentDto } from '../dto';
import type { RequestTrace } from '@/common/cqrs/request-trace';
import type { ICommand } from '@package/types';

export class CreateContentAttachmentCommand implements ICommand {
  ...
  constructor(
    ...
    public readonly dto: CreateContentAttachmentDto,
    trace: RequestTrace = {}
  ) {
