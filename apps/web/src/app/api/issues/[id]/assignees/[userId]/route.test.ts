...
describe('issue assignee delete proxy route', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    global.fetch = vi.fn();
  });

  it('forwards DELETE assignee requests with auth and tenant headers', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith(
      'http://localhost:3001/api/v1/tickets/7/assignees/9',
